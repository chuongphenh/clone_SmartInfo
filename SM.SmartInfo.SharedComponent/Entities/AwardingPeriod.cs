...
{
    public class AwardingPeriod : BaseEntity
    {
        ...
        public const string C_AwardingTime = "AwardingTime";
        private DateTime? _AwardingTime;
        [PropertyEntity(C_AwardingTime, false)]
        public DateTime? AwardingTime
        {
            get { return _AwardingTime; }
            set { _AwardingTime = value; NotifyPropertyChanged(C_AwardingTime); }
        }
        ...
        public AwardingPeriod() : base("AwardingPeriod", "Id", string.Empty, string.Empty) { }
    }
}
