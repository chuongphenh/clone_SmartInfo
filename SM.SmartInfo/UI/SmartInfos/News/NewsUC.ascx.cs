...
namespace SM.SmartInfo.UI.SmartInfos.News
{
    public partial class NewsUC : UserControl
    {
        ...
        public void BindData(int? newsID, bool? isEdit)
        {
            ...
            NewsParam param = new NewsParam(FunctionType.News.GetListSingleNewsByNewsID);
            param.NewsID = newsID;
        ...
        private void BindObjectToRepeater(RepeaterItem rptItem)
        {
            ...
            UIUtility.SetRepeaterItemIText(rptItem, "ltrSummary", item.Summary);
        ...
        private SingleNews GetCurrentRowData(RepeaterItem rptItem)
        {
            ...
            Literal ltrSummary = rptItem.FindControl("ltrSummary") as Literal;
            Literal ltrLink = rptItem.FindControl("ltrLink") as Literal;
            Literal ltrAttachments = rptItem.FindControl("ltrAttachments") as Literal;
            ...
            result.Summary = ltrSummary.Text;
