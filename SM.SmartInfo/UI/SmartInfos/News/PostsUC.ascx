<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PostsUC.ascx.cs" Inherits="SM.SmartInfo.UI.SmartInfos.News.PostsUC" %>
...
<asp:HiddenField ID="hidIsSaved" runat="server" />
<div class="row">
    <div class="err">
    ...
    <div class="row blog blog-medium">
        <div class="col-md-12 table-responsive" style="padding-left: 0px; padding-right: 0px">
            <table class="table" style="border: 1px solid #D9D9D9; box-sizing: border-box;">
                ...
                <thead>
                    <tr>
                        <th colspan="2" style="font-size: 16px; color: #262626; text-align: left; padding-left: 25px;">Bài viết</th>
                        <th></th>
                        <th></th>
                        <th></th>
                        <th></th>
...
<tk:PopupPanel ID="popEdit" runat="server" Title="THÊM MỚI/CẬP NHẬT BÀI VIẾT" Width="800" CancelButton="btnCancel" OnPopupClosed="popEdit_PopupClosed">
    <PopupTemplate>
        <table class="table" style="width: 100%; margin-bottom: 0px">
            ...
            <tr>
                ...
                <td>
                    <tk:TextArea ID="txtContent" runat="server" Width="100%" TextMode="MultiLine" Rows="3" MaxLength="1024"></tk:TextArea>
