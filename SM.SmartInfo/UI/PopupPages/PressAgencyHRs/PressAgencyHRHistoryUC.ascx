<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PressAgencyHRHistoryUC.ascx.cs"
    Inherits="SM.SmartInfo.UI.PopupPages.PressAgencyHRs.PressAgencyHRHistoryUC" %>
        ...
        <asp:Repeater ID="rptHistory" runat="server" OnItemDataBound="rptHistory_ItemDataBound" OnItemCommand="rptHistory_ItemCommand">
            <ItemTemplate>
                <li style="padding-right: 5px;">
                    <p class="pa-date">
                        <asp:HiddenField ID="hidPressAgencyHRHistoryID" runat="server" />
                        <asp:Literal ID="ltrMeetedDTG" runat="server"></asp:Literal>
                        <tk:DatePicker ID="dpkMeetedDTG" runat="server" Width="100%" DateFormat="DMY" Visible="false" />
                    </p>
    ...
    <PopupTemplate>
        <table class="table" style="width: 100%; margin-bottom: 0px">
            ...
            <tr>
                ...
                <td>
                    <asp:HiddenField ID="hidPressAgencyHRHistoryID" runat="server"></asp:HiddenField>
                    <tk:DatePicker ID="dpkMeetedDTG" runat="server" Width="100%" DateFormat="DMY" />
                </td>
            </tr>
            <tr>
                <th>Nội dung
