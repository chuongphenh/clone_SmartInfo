<%@ Page Title="Chi tiết Đường/Phố/Đại lộ" Language="C#" MasterPageFile="~/UI/MasterPages/Common/SmartInfo.Master"
    AutoEventWireup="true" CodeBehind="Display.aspx.cs" Inherits="SM.SmartInfo.UI.Administrations.Street.Display" %>
            ...
            <li>
             ...
             <li>
                <asp:LinkButton ID="btnDelete" runat="server" OnClick="btnDelete_Click"
                    OnClientClick="return confirm('Bạn có chắc chắn muốn xóa đường/phố/đại lộ không?')" Visible="false">
