...
namespace SM.SmartInfo.UI.Administrations.Street
{
    public partial class AddNew : BasePage, ISMFormAddNew<SystemParameter>
    {
        ...
        protected void ddlProvince_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                List<SystemParameter> lstItem = GlobalCache.GetListSystemParameterByFeatureIDAndExt1i(SMX.Features.smx_District, Utility.GetInt(ddlProvince.SelectedValue));
                UIUtility.BindSPToDropDownList(ddlDistrict, lstItem, true);
            }
        ...
        public void SetupForm()
        {
            ...
            ////2. Load all data
            SystemParameterParam param = new SystemParameterParam(FunctionType.Administration.Street.SetupAddFormStreet);
        ...
        public object AddNewItem()
        {
            ...
            SystemParameterParam param = new SystemParameterParam(FunctionType.Administration.Street.AddNewStreet);
