...
namespace SM.SmartInfo.UI.Administrations.Street
{
    public partial class Display : BasePage, ISMFormDisplay<SystemParameter>
    {
        ...
        public void DeleteItems()
        {
            ...
            var param = new SystemParameterParam(FunctionType.Administration.Street.DeleteItemsStreet);
        ...
        public void BindObjectToForm(SystemParameter item)
        {
            ...
            lblDistrict.Text = district.Name;
            lblProvince.Text = GlobalCache.GetNameByID(district.Ext1i);
        }
