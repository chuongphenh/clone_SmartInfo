...
namespace SM.SmartInfo.UI.Administration.Notifications
{
    public partial class Edit : BasePage, ISMFormEdit<SystemParameter>
    {
        ...
        {
            var param = new SystemParameterParam(FunctionType.Administration.Notification.UpdateNotification);
        ...
        public SystemParameter BindFormToObject()
        {
            ...
            item.FeatureID = SMX.Features.Notification;
            item.Ext2i = (int?)txtExt2i.Value;
