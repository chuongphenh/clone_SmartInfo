...
namespace SM.SmartInfo.UI.Administration.Notifications
{
    public partial class Display : BasePage, ISMFormDisplay<SystemParameter>
    {
        ...
        public void LoadData()
        {
            ...
            var param = new SystemParameterParam(FunctionType.Administration.Notification.LoadDataEditNotification);
        ...
        public void DeleteItems()
        {
            ...
            var param = new SystemParameterParam(FunctionType.Administration.Notification.DeleteItemsNotification);
        ...
        public void BindObjectToForm(SystemParameter item)
        {
            ...
            ltrExt1i.Text = Utility.GetDictionaryValue(SMX.Notification.CauHinhGuiThongBao.dicDesc, item.Ext1i);
            ltrExt2i.Text =Utility.GetString(item.Ext2i);
        }
        #endregion
