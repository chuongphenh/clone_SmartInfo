<%@ Page Title="Cấu hình thông báo" Language="C#" MasterPageFile="~/UI/MasterPages/Common/SmartInfo.Master"
    AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="SM.SmartInfo.UI.Administration.Notifications.Edit" %>
    ...
    <div class="content">
        ...
        <table class="tabLogin" style="width: 100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td colspan="3">
                    <tk:NumericTextBox ID="txtExt2i" runat="server" Width="220px" AllowThousandDigit="false" NumberDecimalDigit="0" />
                </td>
            </tr>
        </table>
    </div>
