<%@ Page Title="Cấu hình các ngày đặc biệt" Language="C#" MasterPageFile="~/UI/MasterPages/Common/SmartInfo.Master"
    AutoEventWireup="true" CodeBehind="AddNew.aspx.cs" Inherits="SM.SmartInfo.UI.Administration.Anniversarys.AddNew" %>
        ...
        <ul class="icon_toolbar">
            <li>
                <asp:LinkButton ID="btnSave" OnClick="btnSave_Click" runat="server">
                    <i class="far fa-save" aria-hidden="true" title="Lưu" style="font-size: 16px;"></i>
    ...
    <div class="content">
        ...
        <table class="tabLogin" style="width: 100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>
                    <tk:DatePicker ID="dtpExt4" runat="server" Width="220px" DateFormat="DMY" />
                </td>
