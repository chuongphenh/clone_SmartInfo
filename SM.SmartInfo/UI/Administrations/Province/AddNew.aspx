<%@ Page Title="Tạo mới tỉnh thành" Language="C#" MasterPageFile="~/UI/MasterPages/Common/SmartInfo.Master"
    AutoEventWireup="true" CodeBehind="AddNew.aspx.cs" Inherits="SM.SmartInfo.UI.Administrations.Province.AddNew" %>
    ...
    <div class="content">
        ...
        <table cellpadding="0" cellspacing="0" class="tableDisplay" width="100%">
            ...
            <tr>                
                ...
                <td>
                    <asp:DropDownList ID="ddlZone" runat="server" DataTextField="Name" DataValueField="SystemParameterID" />
                </td>
                <th>Trạng thái
                </th>
                <td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <tk:NumericTextBox ID="txtDisplayOrder" runat="server" Width="220" NumberDecimalDigit="0"></tk:NumericTextBox>
                </td>
            </tr>
            <tr>
                <th>Ghi chú
