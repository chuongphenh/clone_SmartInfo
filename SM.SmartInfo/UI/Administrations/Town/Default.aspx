<%@ Page Title="Danh sách xã/phường" Language="C#" MasterPageFile="~/UI/MasterPages/Common/SmartInfo.Master"
    AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SM.SmartInfo.UI.Administrations.Town.Default" %>
        ...
        <ul class="icon_toolbar">
            <li>
                <asp:LinkButton ID="btnExport" runat="server" OnClick="btnExport_Click" Visible="false">
                    <i class="fa fa-file-excel-o" aria-hidden="true" style="color: black; font-size: 16pt; margin-top: 5px;" title="Xuất Excel"></i>
                </asp:LinkButton>
            </li>
            <li>
                <asp:HyperLink ID="hypAdd" runat="server" Visible="false">
                    <i class="fa fa-plus" aria-hidden="true" style="color: black; font-size: 16pt; margin-top: 5px;" title="Tạo mới"></i>
                </asp:HyperLink>
            </li>
        </ul>
    </div>
