...
namespace SM.SmartInfo.UI.Administrations.District
{
    public partial class Edit : BasePage, ISMFormEdit<SystemParameter>
    {
        ...
        public void SetupForm()
        {
            ...
            var param = new SystemParameterParam(FunctionType.Administration.District.SetupEditFormDistrict);
        ...
        {
            //1. Get data
            var param = new SystemParameterParam(FunctionType.Administration.District.LoadDataEditDistrict);
        ...
        {
            var param = new SystemParameterParam(FunctionType.Administration.District.UpdateDistrict);
        ...
        public void BindObjectToForm(SystemParameter item)
        {
            ...
            ddlProvince.SelectedValue = Utility.GetString(item.Ext1i);
        }
