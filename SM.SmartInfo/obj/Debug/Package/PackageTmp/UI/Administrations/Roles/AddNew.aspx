<%@ Page Title="Tạo mới nhóm người dùng" Language="C#" AutoEventWireup="true" CodeBehind="AddNew.aspx.cs"  MasterPageFile="~/UI/MasterPages/Common/SmartInfo.Master"
    Inherits="SM.SmartInfo.UI.Administrations.Roles.AddNew" %>
    ...
    <div class="content">
        <table class="tabLogin" style="width: 100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td></td>
                <td>
                    <asp:TextBox runat="server" ID="txtName" Width="99%" MaxLength="256" />
                </td>
                <td></td>
            </tr>
            <tr style="height: 30px; font-weight: bold;">
