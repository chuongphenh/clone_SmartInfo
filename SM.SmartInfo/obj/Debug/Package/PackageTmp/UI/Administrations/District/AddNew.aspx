<%@ Page Title="Tạo mới quận huyện" Language="C#" MasterPageFile="~/UI/MasterPages/Common/SmartInfo.Master"
    AutoEventWireup="true" CodeBehind="AddNew.aspx.cs" Inherits="SM.SmartInfo.UI.Administrations.District.AddNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content">
        ...
        <table cellpadding="0" cellspacing="0" class="tableDisplay" width="100%">
            ...
            <tr>
                <th>
                    Mã <span class="star">*</span>
                </th>
                <td>
                    <asp:TextBox ID="txtCode" MaxLength="128" runat="server" Width="200px"></asp:TextBox>
                </td>
                <th>
                    Tên <span class="star">*</span>
                </th>
                <td>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:DropDownList runat="server" ID="ddlProvince" Width="205" />
                </td>
                <th>
                    Trạng thái
                </th>
