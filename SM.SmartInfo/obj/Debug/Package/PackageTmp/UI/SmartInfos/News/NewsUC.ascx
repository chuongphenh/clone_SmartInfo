<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewsUC.ascx.cs" Inherits="SM.SmartInfo.UI.SmartInfos.News.NewsUC" %>
    ...
    <div class="row blog blog-medium">
        <div class="col-md-12 table-responsive" style="padding-left: 0px; padding-right: 0px">
            <table class="table" style="border: 1px solid #D9D9D9; box-sizing: border-box;">
                ...
                <thead>
                    <tr>
                        <th colspan="2" style="font-size: 16px; color: #262626; text-align: left; padding-left: 25px;">Tin lẻ</th>
                        <th></th>
                        <th></th>
                        <th></th>
                        <th></th>
                ...
                <tbody>
                    <asp:Repeater ID="rptSingleNews" runat="server" OnItemDataBound="rptSingleNews_ItemDataBound" OnItemCommand="rptSingleNews_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td class="center">
                                    ...
                                    <asp:HiddenField ID="hidSingleNewsID" runat="server" />
                                </td>
                                <td class="">
                                    <asp:Literal ID="ltrTitle" runat="server"></asp:Literal></td>
                                <td class="center">
                                    <asp:Literal ID="ltrPostedDate" runat="server"></asp:Literal></td>
                                <td class="center">
                                    <asp:Literal ID="ltrChanel" runat="server"></asp:Literal></td>
                                <td class="justify">
                                    <asp:Literal ID="ltrSummary" runat="server"></asp:Literal></td>
                                <td class="">
                                    <asp:Literal ID="ltrLink" runat="server"></asp:Literal></td>
                                <td class="center">
                                    <asp:Literal ID="ltrAttachments" runat="server"></asp:Literal></td>
...
<tk:PopupPanel ID="popEdit" runat="server" Title="THÊM MỚI/CẬP NHẬT TIN LẺ" Width="800" CancelButton="btnCancel" OnPopupClosed="popEdit_PopupClosed">
    <PopupTemplate>
        <table class="table" style="width: 100%; margin-bottom: 0px">
            ...
            <tr>
                <th>Tiêu đề <span class="star">*</span></th>
                <td>
                    <asp:HiddenField ID="hidSingleNewsID" runat="server"></asp:HiddenField>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtMediaChanel" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>Tóm tắt
                ...
                <td>
                    <tk:TextArea ID="txtSummary" runat="server" Width="100%" TextMode="MultiLine" Rows="3" MaxLength="1024"></tk:TextArea>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtLink" Width="100%" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>Upload ảnh 
                    <%--<asp:Button ID="btnPreview" Text="Xem preview ảnh" runat="server" OnClick="btnPreview_Click" />--%>
                </th>
                <td>
                    <div class="custom-file mb-3">
                        <asp:FileUpload runat="server" ID="uploadedImages" class="custom-file-input-att" Style="width: 220px" AllowMultiple="true" accept=".png,.jpg,.gif,.jpeg,.bmp" />
                    ...
                    <asp:RegularExpressionValidator ID="revfulDocument"
                        ...
                        ErrorMessage="Chỉ tải được file(Ảnh)."
                        ControlToValidate="uploadedImages" runat="server" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))+(.gif|.GIF|.jpg|.JPG|.jpeg|.JPEG|.png|PNG)$" ForeColor="Red" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
