<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RelationsPressAgencyUC.ascx.cs"
    Inherits="SM.SmartInfo.UI.SmartInfos.PressAgencies.RelationsPressAgencyUC" %>
...
<div class="row">
    ...
    <div class="headline" style="text-align: center; position: relative; top: -49px; right: 0px;">
        <asp:LinkButton ID="btnAddNew" runat="server" OnClick="btnAddNew_Click" Style="font-size: 16pt; float: right; padding-right: 5px">
            <i class="fa fa-plus" title="Thêm mới quan hệ giữa các tổ chức"></i>
        </asp:LinkButton>
    </div>
                    ...
                    <ItemTemplate>
                        <tr>
                            <td class="center">
                                ...
                                <asp:HiddenField ID="hidRelationsPressAgencyID" runat="server" />
                            </td>
                            <td>
                                <asp:Literal ID="ltrName" runat="server"></asp:Literal></td>
                            <td>
                                <asp:Literal ID="ltrRelationship" runat="server"></asp:Literal></td>
                            <td>
...
<tk:PopupPanel ID="popEdit" runat="server" Title="THÊM MỚI/CẬP NHẬT QUAN HỆ" Width="800" CancelButton="btnCancel" OnPopupClosed="popEdit_PopupClosed">
    <PopupTemplate>
        <table class="table" style="width: 100%; margin-bottom: 0px">
            ...
            <tr>
                <th>Cơ quan</th>
                <td>
                    <asp:HiddenField ID="hidRelationsPressAgencyID" runat="server"></asp:HiddenField>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtNote" runat="server" Width="100%" MaxLength="256"></asp:TextBox>
                </td>
            </tr>
        </table>
