<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PressAgencyMeetingUC.ascx.cs"
    Inherits="SM.SmartInfo.UI.SmartInfos.PressAgencies.PressAgencyMeetingUC" %>
...
<div class="row">
    ...
    <div class="headline" style="text-align: center; position: relative; top: -49px; right: 0px;">
        <asp:LinkButton ID="btnAddNew" runat="server" OnClick="btnAddNew_Click" Style="font-size: 16pt; float: right; padding-right: 5px">
            <i class="fa fa-plus" title="Thêm mới lịch sử hợp tác gặp gỡ"></i>
        </asp:LinkButton>
    </div>
                    ...
                    <ItemTemplate>
                        <tr>
                            <td class="center">
                                ...
                                <asp:HiddenField ID="hidPressAgencyMeetingID" runat="server" />
                            </td>
                            <td>
                                <asp:Literal ID="ltrContractNo" runat="server"></asp:Literal></td>
                            <td>
                                <tk:DatePicker ID="dpkContractDTG" runat="server" Visible="false" DateFormat="DMY"></tk:DatePicker>
                                <asp:Literal ID="ltrContractDTG" runat="server"></asp:Literal></td>
                            <td>
                                <asp:Literal ID="ltrPartner" runat="server"></asp:Literal></td>
                            <td>
                                <asp:Literal ID="ltrLocation" runat="server"></asp:Literal></td>
                            <td>
                                <asp:Literal ID="ltrContent" runat="server"></asp:Literal></td>
                            <td class="center">
                                <tk:DatePicker ID="dpkMeetDTG" runat="server" Width="100%" DateFormat="DMY" Visible="false" />
                                <asp:Literal ID="ltrMeetDTG" runat="server"></asp:Literal></td>
                            <td id="tdEdit" runat="server" class="center">
                                <asp:LinkButton ID="btnUpload" runat="server" Style="margin-right: 5px"><i class="fa fa-upload" title="Upload tài liệu"></i></asp:LinkButton>
    ...
    <PopupTemplate>
        <table class="table" style="width: 100%; margin-bottom: 0px">
            ...
            <tr>
                <th>Số HĐ</th>
                <td>
                    <asp:HiddenField ID="hidPressAgencyMeetingID" runat="server"></asp:HiddenField>
                    <asp:TextBox ID="txtContractNo" runat="server" Width="100%" MaxLength="256"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>Ngày ký HĐ</th>
                <td>
                    <tk:DatePicker ID="dpkContractDTG" runat="server" DateFormat="DMY" Width="100%"></tk:DatePicker>
                </td>
            </tr>
            <tr>
                <th>Đối tác</th>
                <td>
                    <asp:TextBox ID="txtPartner" runat="server" Width="100%" MaxLength="256"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>Địa điểm
                ...
                <td>
                    <asp:TextBox ID="txtLocation" runat="server" Width="100%" MaxLength="256"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>Thời gian
                ...
                <td>
                    <tk:DatePicker ID="dpkMeetDTG" runat="server" Width="100%" DateFormat="DMY" />
                </td>
            </tr>
            <tr>
                <th>Nội dung
                ...
                <td>
                    <tk:TextArea ID="txtContent" runat="server" Width="100%" TextMode="MultiLine" Rows="3"></tk:TextArea>
                </td>
            </tr>
        </table>
