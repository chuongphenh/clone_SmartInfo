<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/MasterPages/Common/Popup.Master" CodeBehind="Display.aspx.cs"
    Inherits="SM.SmartInfo.UI.PopupPages.EmulationAndRewards.Display" %>
            ...
            <div class="col-md-12" style="background: rgb(255, 255, 255); border-radius: 5px;">
                <div style="width: 100%; padding-left: 15px; padding-right: 15px; padding-top: 15px; padding-bottom: 15px; text-align: left">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11 div-display" style="width: 85%">
                            <asp:Label ID="ltrUnit" runat="server" Style="font-size: 14px"></asp:Label>
                        </div>
                    </div>
                    <hr />
                    <div class="row">
                        ...
                        <div class="col-md-11 div-display" style="width: 85%">
                            <asp:Label ID="ltrEmail" runat="server" Style="font-size: 14px"></asp:Label>
                        </div>
                    </div>
                    <hr />
                    <div class="row">
                        ...
                        <div class="col-md-11 div-display" style="width: 85%">
                            <asp:Label ID="ltrMobile" runat="server" Style="font-size: 14px"></asp:Label>
                        </div>
                    </div>
                    <hr />
                    <div class="row">
                                ...
                                <div class="new-grid">
                                    <asp:DataGrid ID="grdData" runat="server" ShowHeader="true" ShowFooter="false" AllowPaging="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderText="Hình thức khen thưởng" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Literal ID="ltrAwardingType" runat="server"></asp:Literal>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
